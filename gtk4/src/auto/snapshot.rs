...
pub trait SnapshotExt: 'static {
    ...
    fn to_node(&self) -> gsk::RenderNode;

    #[doc(alias = "gtk_snapshot_to_paintable")]
    fn to_paintable(&self, size: Option<&graphene::Size>) -> gdk::Paintable;
...
impl<O: IsA<Snapshot>> SnapshotExt for O {
    ...
    fn to_node(&self) -> gsk::RenderNode {
        unsafe { from_glib_full(ffi::gtk_snapshot_to_node(self.as_ref().to_glib_none().0)) }
    }
